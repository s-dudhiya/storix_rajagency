                    ...
                    <div className="flex items-start justify-between gap-4 flex-col sm:flex-row">
                      ...
                      <div className="flex flex-row items-center justify-between w-full sm:w-auto mt-3 sm:mt-0 pt-3 sm:pt-0 border-t sm:border-t-0 border-border/50 gap-4">
                        <div className="text-left sm:text-right">
                          ...
                          <p className="text-xl sm:text-2xl font-bold text-primary tracking-tight">₹{order.total_amount.toFixed(2)}</p>
                        </div>

                        <div className="flex gap-2 sm:w-auto">
                          <Link href={`/owner/order-details/${order.id}`} className="flex-none">
                            <Button variant="outline" size="sm" className="w-9 px-0 sm:w-auto sm:px-3 gap-2 h-9 border-border/60 hover:bg-background hover:border-primary/30 hover:text-primary transition-all shadow-sm">
                              <Eye size={15} />
